...
DISK_ACT=50                         ## Percentage of disk usage that will trigger compression
DISK_MAX=95                         ## Set MAX percentage of disk usage
ZIP_ATATIME=100                     ## Number of files to ZIP
DEL_ATATIME=20                      ## How many files to delete per iteration
...
do
  ...
  do
    ...
    tar -I 'pbzip2 -m2000 -p12' -cvf $archive_filename $oldest_n_files >> /srv/scripts/LOGS/TAR_DEBUG.$ref_date.log
